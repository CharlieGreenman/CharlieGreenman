...
In our heyday, we had 25 people as part of the organization reporting directly to me. These days, while Razroo's IP is arguably worth millions of dollars, our organization is a bit smaller. 
...
▲ NextJS       ██████████████████████░░░   Advanced
💿 Remix        ██████████████████████░░░   Advanced
🛣️ React Router 7 ████████████████████░░░   Advanced
🔷 Nx           ██████████████████████░░░   Advanced
🏪 NgRx/store   ██████████████████████░░░   Advanced
🔄 Redux        ██████████████████████░░░   Advanced
🤔 Reason       ██████████████████████░░░   Advanced
⚡ Velocity     ██████████████████████░░░   Advanced
🏗️ Zurb Foundation ████████████████████░░░   Advanced
...
I wrote about 600 of these pages riding on the QM4 bus between Queens and Manhattan. I lived in Washington Heights for a while, consulting for Columbia University. When I did I wrote this book while on the Uber on the way there and back (yes I make money). 
...
About 200 of my articles are on the Razroo blog. Like an idiot, I deleted about 70 articles from Medium and messed up my SEO to move to this blog. Learn from me and don't do that. Double post on both sites, but... we now have AI, so yeah. 
...
**[codemorph](https://github.com/razroo/codemorph)** ⭐ 24
An extensible, cross-platform codemod library designed for accessibility and contribution. Built to make code transformations simple and maintainable across different frameworks and languages.

**[reason-oop-patterns](https://github.com/CharlieGreenman/reason-oop-patterns)** ⭐ 13
Gang of Four design patterns implemented using the Reason programming language. A comprehensive guide showing how classic OOP patterns translate to functional programming paradigms.

**[package-json-manager](https://github.com/razroo/package-json-manager)** ⭐ 5
A tool for autonomous versioning that streamlines installation of correct package versions via npm. Simplifies dependency management across complex projects.

**[tyson](https://github.com/razroo/tyson)** ⭐ 5
Enables TypeScript usage within JSON files to simplify DevOps configurations. Brings type safety and intellisense to configuration files.

**[razm](https://github.com/razroo/razm)** ⭐ 5
WebAssembly-first frontend framework middleware. Pushing the boundaries of web performance with WASM integration.
...
* 🎓 **Ruffalo Noel Levitz** - AI Chat application (worked at for negligible amount of time. During a chaotic shift in industry, in hindsight should have never joined.)
...
* ⚖️ **Rubenstein Technology Group** - Front End Software Engineer for AM100 law firm solutions (2015-2016 - engineering talent punched well above its weight)
...
*I blame my overly ambitious younger self (went to 6 figures in 1.5 years by age 24, and doubled that amount by 26, so who is to blame? I thought I would continue to double amount in the next 3 years, but industry started changing.) Entrepreneurship, living overseas for five years, Covid-19 (non-remote to remote, and then back to non-remote wrecked a lot of teams) and December 2023 AKA AI Doom Month (I lost two contracts that month), for the amount of companies I worked for. Also the industry has taken pay cuts for the first time in past 15 years. I didn't understand that until recently and was very unhappy with roles I had a year ago, which is why I left two of those roles.*
