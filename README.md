...
**[angular-material-virtual-scroll-cdk-table](https://github.com/CharlieGreenman/angular-material-virtual-scroll-cdk-table)** ⭐ 9
Angular Material virtual scrolling implementation for CDK tables. Optimizes rendering performance for large datasets.

**[anthropic-claude-playground](https://github.com/razroo/anthropic-claude-playground)** ⭐ 6
Official Claude AI playground built and generated by Razroo. Experiment with Claude's capabilities in an interactive environment.

**[Html5Tetris](https://github.com/CharlieGreenman/Html5Tetris)** ⭐ 6
Classic Tetris game built with HTML5 Canvas. A fun demonstration of game development fundamentals.

**[webpack-angular1.5-razroo](https://github.com/CharlieGreenman/webpack-angular1.5-razroo)** ⭐ 5
Webpack2 build configuration for Angular 1.5 applications. Modern build tooling for legacy Angular apps.

**[html-to-adf](https://github.com/razroo/html-to-adf)** ⭐ 4
Converts HTML to Atlassian Document Format (ADF). Essential for Confluence and Jira integrations.

**[employee-dashboard-angular](https://github.com/razroo/employee-dashboard-angular)** ⭐ 4
Fully architected employee dashboard built with Angular. Demonstrates enterprise-grade architecture and best practices.

**[founder-mode](https://github.com/CharlieGreenman/founder-mode)** ⭐ 3
Book project exploring the founder mindset and entrepreneurial thinking.

**[codeIllustrator](https://github.com/CharlieGreenman/codeIllustrator)** ⭐ 3
Vanilla JavaScript drawing tool that converts illustrations to code. Draw-to-code conversion prototype.
